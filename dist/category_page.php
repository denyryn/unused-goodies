        ...
        <?php foreach ($categories as $category) { ?>
            ...
            <a href="product_page.php?category_id=<?php echo $category['category_id']; ?>" class="relative block group">
                <div class="relative h-[200px] sm:h-[300px]">
                    <img src="<?php echo $category['image_base_path']; ?>" alt="<?php echo $category['category_name']; ?>" class="absolute inset-0 object-cover w-full h-full duration-150 opacity-100 group-hover:opacity-0 brightness-50">
                    <img src="<?php echo $category['image_hover_path']; ?>" alt="<?php echo $category['category_name']; ?>" class="absolute inset-0 object-cover w-full h-full duration-150 opacity-0 group-hover:opacity-100 brightness-50">
                </div>
                <div class="absolute inset-0 flex flex-col items-start justify-end p-6">
                    <h3 class="text-xl font-medium text-white"><?php echo $category['category_name']; ?></h3>
                    <p class="mt-1.5 max-w-[40ch] text-xs text-white"><?php echo $category['category_description']; ?></p>
                    <span class="inline-block px-5 py-3 mt-3 text-xs font-medium tracking-wide text-white uppercase bg-black">Shop Now</span>
                </div>
            </a>
