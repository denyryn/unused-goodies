...
<body>
    ...
    ?>
        ...
        <div class="navbar bg-base-100">
            <div class="navbar-start">
                <a href="main_page.php" class="btn hover:bg-transparent btn-ghost w-fit h-fit"><img class="flex items-center justify-center w-14" src="../assets/svg/logo.svg" alt=""></a>
            </div>
            ...
            <div class="navbar-end">
                <a data-modal-target="cart-modal" data-modal-toggle="cart-modal" class="flex bg-transparent border-none shadow-none outline-none btn lg:hidden" type="button">
                ...
                <a data-modal-target="cart-modal" data-modal-toggle="cart-modal" class="hidden bg-transparent border-none shadow-none outline-none lg:flex btn" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="black" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <circle cx="9" cy="21" r="1" />
                        <circle cx="20" cy="21" r="1" />
                        <path d="M1 1h4l2.68 13.39a2 2 0 0 0 1.92 1.61h10.8a2 2 0 0 0 1.92-1.61L23 6H6" />
        ...
        <div class="flex items-center justify-center">
            ...
            <div class="relative items-center w-full max-w-lg px-5 py-6 bg-white rounded-lg shadow-lg"> 
                <a data-modal-hide="cart-modal">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 cursor-pointer shrink-0 fill-[#333] hover:fill-red-500 float-right" viewBox="0 0 320.591 320.591">
                ...
                <?php foreach ($cartItems as $cartItem): ?>
                    <div class="mt-6 space-y-6">
                        <div class="flex items-center">
                            ...
                            <img src='<?php echo $cartItem['image_path']; ?>' class="object-cover w-16 h-16 p-2 bg-gray-100 aspect-square shrink-0" />
                            ...
                            <div class="flex-1 ml-4">
                                ...
                                <p class="mt-1 text-xs tracking-wide text-gray-400"><?php echo $cartItem['quantity']; ?> in cart</p>
                            </div>

                            <div>
                                <!-- Display product total cost -->
                                <span class="mr-5 text-sm font-semibold">
                                    Rp <?php echo number_format($cartItem['quantity'] * $cartItem['price'], 2, ',', '.'); ?>
                                </span>
                                ...
                                <a remove-product="<?php echo $cartItem['product_id']; ?>" class="remove-product">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline w-5 cursor-pointer fill-red-500" viewBox="0 0 24 24">
                ...
                <div class="flex max-sm:flex-col gap-4 !mt-6 w-full">
                    <a href="./checkout_products.php?user_id=<?php echo $_SESSION['user_id']; ?>" type="button" class="btn px-6 py-2.5 w-full transition duration-200 ease-in-out active:scale-95 bg-blue-600 hover:bg-blue-700 text-white rounded-md">
                        Check out
                    </a> 
                </div>
            </div>
    ...
    ?>
        ...
        <div class="navbar bg-base-100">
            <div class="navbar-start">
                <a class="btn hover:bg-transparent btn-ghost w-fit h-fit"><img class="flex items-center justify-center w-14" src="../assets/svg/logo.svg" alt=""></a>
            </div>
            <div class="hidden navbar-center lg:flex ">
                <ul class="px-1 font-bold menu menu-horizontal font-rubik">
                    <li><a href="main_page.php">Home</a></li>
            ...
            <div class="navbar-end">
                ...
                <a href="./login_page.php" class="hidden bg-transparent border-none shadow-none outline-none lg:flex btn hover:bg-transparent">
                    <img class="w-5 h-5" src="../assets/svg/user.svg" alt="">
                </a>
            </div>
        </div>
