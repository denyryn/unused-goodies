    ...
    <div class="min-h-screen hero bg-base-200">
        <div class="flex-col hero-content lg:flex-row-reverse">
            <div class="text-center lg:ml-12 lg:text-left">
                ...
                <p class="py-6" id="login-quote">Loading our unique Login quotes to cheer you up. So make sure to Login and checkout our goodies :)</p>
            </div>
            <div class="w-full max-w-sm shadow-2xl card shrink-0 bg-base-100">
                <form class="card-body" action="./php/login.php" method="post">
                    <div class="form-control">
                        ...
                        <input id="username_or_email" name="username_or_email" type="text" value="<?php echo $username_or_email; ?>" placeholder="email or username" class="input input-bordered" required />
                    ...
                    <div class="form-control">
                        ...
                        <p class="p-1 text-xs">Still doesnt have an account? &nbsp<a class="hover:underline" href="../dist/register_page.php">Signup here</a>.</p>
                    </div>
                    <div class="mt-1 form-control">
                        <button class="text-white bg-black border-black btn btn-primary hover:bg-white hover:text-black hover:border-black">Login</button>
                    </div>
                </form>
            </div>
        </div>
