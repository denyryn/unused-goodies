    ...
    <div class="min-h-screen hero bg-base-200">
        <div class="flex-col hero-content lg:flex-row-reverse">
            <div class="text-center lg:ml-12 lg:text-left">
                ...
                <p class="py-6" id="signup-quote">Loading our unique Signup quotes to cheer you up. So make sure to Signup and checkout our goodies :)</p>            
            </div>
            <div class="w-full max-w-sm shadow-2xl card shrink-0 bg-base-100">
                <form class="card-body" action="./php/register.php" method="post">
                    ...
                    <div class="mt-6 form-control">
                        <button class="text-white bg-black border-black btn btn-primary hover:bg-white hover:text-black hover:border-black">Signup</button>
                    </div>
                </form>
            </div>
        </div>
